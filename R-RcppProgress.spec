...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1641090532
...
R CMD check --no-manual --no-examples --no-codoc RcppProgress || :
...
/usr/lib64/R/library/RcppProgress/tests/testthat.R
/usr/lib64/R/library/RcppProgress/tests/testthat/test-pkg_examples.R
/usr/lib64/R/library/RcppProgress/tests/testthat/wrap_examples.R
